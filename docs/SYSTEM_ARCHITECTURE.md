...
* [x] **Sharp Knives Refactor:** Replaced specific condition/behavior files with generic, reusable tools (ConditionIsGrounded, ConditionIsMoving, BehaviorRoll, etc. deleted).
...
* [x] **Memory Debugging** find out why data is displayed as empty in statedebugger, this might just be us not utilizing the blackboard rn.
