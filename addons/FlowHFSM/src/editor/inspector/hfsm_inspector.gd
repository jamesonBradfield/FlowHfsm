...
func _can_handle(object: Object) -> bool:
	return object is FlowState

func _parse_begin(object: Object) -> void:
	if not object is FlowState: return
...
func _re_smash_script(node: Node) -> void:
	...
	var smasher_script: Script = load("res://addons/FlowHFSM/src/editor/workbench/logic_smasher.gd")
...
func _parse_property(object: Object, _type: int, name: String, _hint_type: int, _hint_string: String, _usage_flags: int, _wide: bool) -> bool:
	...
	if name == "behaviors":
		add_property_editor(name, preload("res://addons/FlowHFSM/src/editor/workbench/behavior_editor.gd").new())
		return true

	# Intercept activation_conditions to inline them
	if name == "activation_conditions":
		add_property_editor(name, preload("res://addons/FlowHFSM/src/editor/workbench/condition_editor.gd").new())
		return true

	# Intercept declared_variables to inline them
	if name == "declared_variables":
		add_property_editor(name, preload("res://addons/FlowHFSM/src/editor/workbench/variable_editor.gd").new())
		return true
