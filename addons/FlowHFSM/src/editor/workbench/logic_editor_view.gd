...
const HFSMPropertyFactory = preload("res://addons/FlowHFSM/src/editor/workbench/property_factory.gd")
...
func _get_condition_options() -> Dictionary:
	return {
		"Input Check": "res://addons/FlowHFSM/src/library/conditions/ConditionInput.gd",
		"Float Comparison (> <)": "res://addons/FlowHFSM/src/library/conditions/ConditionFloatCmp.gd",
		"Bool Comparison (==)": "res://addons/FlowHFSM/src/library/conditions/ConditionBoolCmp.gd",
		"Timer Elapsed": "res://addons/FlowHFSM/src/library/conditions/ConditionTimerElapsed.gd"
	}

func _get_behavior_options() -> Dictionary:
	return {
		"Physics (Move/Slide)": "res://addons/FlowHFSM/src/library/behaviors/BehaviorPhysics.gd",
		"Animation Tree": "res://addons/FlowHFSM/src/library/behaviors/BehaviorAnimationTree.gd",
		"Timer Lock (Cooldowns)": "res://addons/FlowHFSM/src/library/behaviors/BehaviorTimerLock.gd",
		"Set Property (Generic)": "res://addons/FlowHFSM/src/library/behaviors/BehaviorSetProperty.gd"
	}
