...
const ThemeResource = preload("res://addons/FlowHFSM/src/editor/theme/flow_hfsm_theme.tres")
const HFSMPropertyFactory = preload("res://addons/FlowHFSM/src/editor/workbench/property_factory.gd")
const StateVariableScript = preload("res://addons/FlowHFSM/src/core/FlowVariable.gd")
...
func _draw_list(variables: Array) -> void:
	...
	for i in range(variables.size()):
		var variable: FlowVariable = variables[i]
...
func _on_add_pressed() -> void:
	...
	# Safe instantiation
	var new_var: FlowVariable = StateVariableScript.new()
