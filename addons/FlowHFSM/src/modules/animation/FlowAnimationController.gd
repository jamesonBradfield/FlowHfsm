class_name FlowAnimationController extends Node
...
const FlowAnimationDriver = preload("res://addons/FlowHFSM/src/core/values/AnimationDriver.gd")
...
@export var drivers: Array[FlowAnimationDriver] = []
...
func _connect_signals_recursive(state: FlowState) -> void:
