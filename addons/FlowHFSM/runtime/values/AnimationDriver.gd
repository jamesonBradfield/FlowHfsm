...
const ValueVector2 = preload("res://addons/FlowHFSM/runtime/values/ValueVector2.gd")
const ValueBool = preload("res://addons/FlowHFSM/runtime/values/ValueBool.gd")
...
@export var value_float: ValueFloat = ValueFloat.new()
@export var value_vector2: ValueVector2 = ValueVector2.new()
@export var value_bool: ValueBool = ValueBool.new()
